...
<div class="dropdown" >
    ...
    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
      <li><a style="background-color:#efe6e6;color:black" class="dropdown-item" href="#">Select</a>
        ...
        <input class="input1"type="number" name="" id="" value="1" min="1" max="8">
...
$sql="SELECT * FROM `bttm` where semester=$semester";
    ...
    <div class="row g-0">
      ...
      <div class="col-md-8">
        ...
        <div class="card-body">
          ...
          <a href="bttmdetail.php?bookid=<?php echo $rows['id'];?>">Know More</a>
