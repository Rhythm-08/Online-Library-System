...
$sql="SELECT * FROM `bttm` WHERE `id` = '{$id}'";
...
<head>
    ...
    <link rel="stylesheet" href="bba_bookdetails.css">
</head>
...
<li class="nav-item">
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="<?php echo $rows['images'];?>" .width="100%" alt="" id="productImg">
...
<a href="" class="btn">Add To cart</a> -->
                <h3>Descrption <i class="fa fa-indent"></i></h3>
                <br>
