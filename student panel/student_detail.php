...
<body>
    ...
    <h2 class="issue-book" style=" margin: 2rem 5rem; background-color: rgb(214, 214, 214);text-align: center;">Issued Books </h2>
  ...
  while($rows = mysqli_fetch_array($result)){
    ...
    ?>
  <div class="card mb-3" style="max-width: 640px;display:inline-block;margin-left:3rem;text-transform:capitalize">
  <div class="row g-0">
    <div class="col-md-4">
      <img src="../images/study1.jpeg" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h4 class="card-title"><?php echo $rows['bookname'] ?></h4>
        <h6 class="card-title text-muted">SEMESTER : <?php echo $rows['semester'] ?></h6>
        <h6 class="card-title text-muted">ISSUE DATE :<?php echo $rows['issue'] ?></h6>
        <h6 class="card-title text-muted">DUE DATE :<?php echo $rows['returnb'] ?></h6>
        <?php
        if($rows['status']==1){
            ?>
        <h6>Status :- <span class="badge bg-success">Returned</span></h6>
        <?php
        }
        ?>
        <?php 
         if($rows['status']!=1){
            ?>
            <h6>Status :- <span class="badge bg-danger">Pending</span></h6>
            <?php
        }
        ?>
        <!-- <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p> -->
        <p class="card-text"><small class="text-muted">Fine : <?php echo $rows['fine'] ?> </small></p>
      </div>
    </div>
  </div>
</div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        ...
                        <ul class="list-unstyled mb-0">
                            <li class="mb-1">
                                <a href="http://localhost/project/Home_page.php" style="color: #93c5fd;">Home</a>
                            </li>
                            <li class="mb-1">
