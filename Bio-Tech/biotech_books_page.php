...
<div class="strip" style="position: fixed; z-index:100;padding-bottom:2rem;margin-bottom:15rem;">
    ...
    <div class="main-drop">
    <form action="bba_books.php" method="GET">
    <div class="dropdown" >
...
$sql="SELECT * FROM `biotech` where semester=$semester";
    ...
    <div class="row g-0">
      ...
      <div class="col-md-8">
        ...
        <div class="card-body">
          ...
          <a href="biodetails.php?bookid=<?php echo $rows['id'];?>">Know More</a>
