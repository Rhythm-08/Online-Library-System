...
<div class="strip" style="position: fixed; z-index:100;padding-bottom:2rem;margin-bottom:15rem;">
    ...
    <div class="main-drop">
    <form action="bhmct_books.php" method="GET">
    <div class="dropdown" >
...
$sql="SELECT * FROM `bhmct` where semester=$semester";
    ...
    <div class="row g-0">
      ...
      <div class="col-md-8">
        ...
        <div class="card-body">
          ...
          <a href="bhmctdetail.php?bookid=<?php echo $rows['id'];?>">Know More</a>
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 mb-4">
          ...
          <ul class="list-unstyled mb-0">
            <li class="mb-1">
              <a href="#!" style="color: #93c5fd;">FAQ</a>
            </li>
            <li class="mb-1">
              <a href="#!" style="color: #93c5fd;">Classes</a>
            </li>
            <li class="mb-1">
              <a href="#!" style="color:  #93c5fd;">Pricing</a>
            </li>
            <li>  
              <a href="#!" style="color:  #93c5fd;">Safety</a>
            </li>
          </ul>
        </div>
        <div class="col-lg-3 col-md-6 mb-4">
