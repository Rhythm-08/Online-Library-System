...
<!-- <section class="ftco-section">
  ...
  <nav class="navbar navbar-light bg-light">
        <div class="container-fluid">
            <a href="http://localhost/project/Home_page.html"class="navbar-brand">PCTE <span style="color:#93c5fd">Library</span></a>
    ...
    <ul class="nav justify-content-center navbar navbar1 con1" style="background-color:#60a5fa" >
        <li class="nav-item">
            <a  style="color:black;"class="nav-link active" aria-current="page" href="#">Active</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a style="color:black;" class="nav-link ">link</a>
        </li>
    </ul>
<!-- strip -->
...
<div class="card mb-1" style="max-width: 1050px; max-height: fit-content;  ">
  ...
  // $semester=$_GET['semester'];
$sql="SELECT * FROM `bhmct` where `name` like '%$q%'";
