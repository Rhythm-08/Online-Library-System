...
<nav class="navbar navbar-light bg-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="http://localhost/project/Home_page.php">PCTE <span style="color:#93c5fd">Library</span></a>
...
<div class="strip" style="position: fixed; z-index:100;padding-bottom:2rem;margin-bottom:15rem;">
    ...
    <div class="main-drop">
    <form action="pharma_books_page.php" method="GET">
    <div class="dropdown" >
...
<div class="container my-5" style="max-width:100%">
  ...
  <footer style="background-color:#4b5563;">
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 mb-4">
          ...
          <ul class="list-unstyled mb-0">
            <li class="mb-1">
              <a href="/Home_page.php" style="color: #93c5fd;">Home</a>
            </li>
            <li class="mb-1">
              <a href="#!" style="color: #93c5fd;">Courses</a>
            </li>
            <li class="mb-1">
              <a href="/Signup folder/stud_signup.php" style="color:  #93c5fd;">Sign up</a>
            </li>
            <li>
              <a href="/Signup folder/stud_signin1.php" style="color:  #93c5fd;">Sign In</a>
            </li>
          </ul>
        </div>
        <div class="col-lg-3 col-md-6 mb-4">
    ...
    <div class="text-center p-3"  style="background-color: rgba(0, 0, 0, 0.2);color:#93c5fd">
      © 2021 Copyright:
      <a class="" style="color:  #93c5fd;" href="/Home_page.php">Designed By Rhythm and Samridh</a>
    </div>
    <!-- Copyright -->
  </footer>
